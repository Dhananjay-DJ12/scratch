...
const LeftSidebar = ({ allShapes }: { allShapes: Array<any> }) => {
  ...
  const memoizedShapes = useMemo(
    () => (
      <section className='sticky left-0 flex h-full sm:min-w-[180px] md:min-w-[220px] lg:min-w-[250px] select-none flex-col 
      overflow-y-auto bg-primary-black pb-20 text-primary-grey-300 max-sm:hidden
      border-t border-primary-grey-200 md1:rounded-tr-[20px]'>
